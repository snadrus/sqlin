...
ada_qualified_type_specification
	:	Interfaces.SQL period CHAR opt_nt_680 left_paren double_period length right_paren
...
pascal_type_specification
	:	PACKED ARRAY left_bracket double_period length right_bracket OF CHAR opt_nt_845
	|	INTEGER
	|	REAL
	|	CHAR opt_nt_847
	|	BOOLEAN
...
func (l *SQLex) Lex(lval *SQSymType) int {
	var c rune = ' '
	for c == ' ' {
		if l.pos == len(l.s) {
			return 0
